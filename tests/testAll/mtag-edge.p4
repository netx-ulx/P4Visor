...
#include "include_mtag/headers.p4"
#include "include_mtag/parser.p4"
#include "include_mtag/actions.p4"  // For actions marked "common_"
...
meter per_dest_by_source {
    ...
    instance_count : PORT_COUNT ;  // Per source/dest pair
}
...
table egress_meter {
    ...
    size : PORT_COUNT ;  // Could be smaller
}
